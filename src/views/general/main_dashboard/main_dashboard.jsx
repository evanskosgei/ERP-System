				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box overflow-hidden">
						<div className="box-body">
							...
							<div className="mt-2">
								<h2 className="text-2xl font-semibold text-gray-800 dark:text-white">Ksh 1,900,506</h2>
								<p className="text-xs text-gray-400 ">In this week</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div className="box-body">
							<div className="flex">
								<div className="flex space-x-3 rtl:space-x-reverse">
									...
									<h6 className="text-lg font-medium text-gray-800 mb-2 dark:text-white my-auto">Stock Levels</h6>
								</div>
							...
							<div className="mt-2">
								<h2 className="text-2xl font-semibold text-gray-800 dark:text-white">Ksh 34,262,458</h2>
								<p className="text-xs text-gray-400 ">Total Stock This Week</p>
							</div>
						</div>
					</div>
				</div>
							...
							<ul className="list-unstyled mb-0 crm-recent-activity">
								...
								<li className="crm-recent-activity-content">
									<div className="flex items-top">
										...
										<div className="crm-timeline-content">
											<span>Stock in transit. <span className="text-info font-semibold">4,568</span> items to receive.</span>
										</div>
								...
								<li className="crm-recent-activity-content">
									<div className="flex items-top">
										...
										<div className="crm-timeline-content">
											<span>Customer inquiry on after sale <i className="ri-checkbox-circle-line text-success fs-16 align-middle"></i></span>
										</div>
										<div className="flex-auto text-end">
								...
								<li className="crm-recent-activity-content">
									<div className="flex items-top">
										...
										<div className="crm-timeline-content">
											<span className="font-semibold">Approve products received &amp;</span><span><Link to="#" className="text-primary font-semibold"> Disbatch products to Managers.</Link></span>
										</div>
										<div className="flex-auto text-end">
								...
								<li className="crm-recent-activity-content">
									<div className="flex items-top">
										...
										<div className="crm-timeline-content">
											<span>Distribution Centers out of Stock <span className="font-semibold">View List</span></span>
											<span className="block fs-12 text-muted">Products on demand our of stock!.</span>
										</div>
										<div className="flex-auto text-end">
								...
								<li className="crm-recent-activity-content">
									<div className="flex items-top">
										...
										<div className="crm-timeline-content">
											<span><span className="text-danger font-semibold">Product Alert!</span> Stock damaged. View Report <span className="avatar w-5 h-5 bg-purple-transparent rounded-full inline-flex ms-1"><i className="ri-add-fill text-purple fs-12"></i></span></span>
										</div>
										<div className="flex-auto text-end">

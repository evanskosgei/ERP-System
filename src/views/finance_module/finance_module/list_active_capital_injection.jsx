...
const Active_capital_injection = () => {
    ...
    return (
        <div>
            {currentDiv === "listpage" && (
                <div>
                    <PageHeader currentpage="Active Capital Injections" href="/finance/expenses/" activepage="Dashboard" mainpage="Active Capital Injections approval" />
            ...
            {currentDiv === "details" && (
                <div>
                    <PageHeader currentpage="Active capital injection Details" activepage="finance" mainpage="Active Capital Injection Details" />

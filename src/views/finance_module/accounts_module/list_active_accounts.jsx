...
const Active_accounts = () => {
    ...
    const columnDefs = [
        ...
        { headerName: "Account Number", field: "number", sortable: true, editable: false, filter: true, flex: 2, resizable: false, minWidth: 10 },
    ...
    return (
        <div>
            {currentDiv === "listpage" && (
                <div>
                    <PageHeader currentpage="Active Accounts" href="/finance/accouting/" activepage="Dashboard" mainpage="Active Accounts" />
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData.length > 0 ? rowData : []} filename="active_approved_Accounts" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "details" && (
                 <div>
                 <PageHeader currentpage="Account Information" href="/finance/accouting/" activepage="Finance" mainpage="Active Account Details" />
                 ...
                 <div className= "box">
                     ...
                     <div className= "box-footer text-end space-x-3 rtl:space-x-reverse" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1rem' }}>
                         ...
                         <Link to="#" className= "ti-btn m-0 ti-btn-soft-primary" onClick={approve}><i className="ri ri-refresh-line"></i> Edit</Link>
                         <Link to="#" className= "ti-btn m-0 ti-btn-soft-secondary"><i className= "ri ri-close-circle-line"></i> Deactivate</Link>
                     </div>
                 </div>
             </div>
             </div>
...
export default Active_accounts;
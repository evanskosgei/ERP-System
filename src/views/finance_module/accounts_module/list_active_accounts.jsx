...
const Active_accounts = () => {
    ...
    return (
        <div>
            {currentDiv === "listpage" && (
                <div>
                    <PageHeader currentpage="Active Accounts" href="/finance/accouting/" activepage="Dashboard" mainpage="Active approved Accounts" />
            ...
            {currentDiv === "details" && (
                <div>
                    <PageHeader currentpage="Active account  Details" activepage="Dashboard" mainpage="Active approved account Details" />

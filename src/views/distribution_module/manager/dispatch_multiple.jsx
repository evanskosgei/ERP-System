...
const Manager_dispatch_multiple = () => {
    const [rowData, setRowData] = useState([]);
    return (
        <div>
            <PageHeader currentpage="Create Multiple Dispatch to Team Leader" href="/inventory/distribution-dashboard" activepage="Dispatch" mainpage="Select Device to Send To Team Leader" />
            <div className="col-span-12">
                <div className="box">
                    <div className="box-header">
                        <h5 className="box-title">Team Leader Details</h5>
                    </div>
...
export default Manager_dispatch_multiple;

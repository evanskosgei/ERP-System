    ...
    {currentDiv === "table" && (
        <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                ...
                />
                <CSVLink data={filteredData.length>0 ? filteredData : rowData.length >0 ? rowData : null} filename="new_unapproved_users.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">

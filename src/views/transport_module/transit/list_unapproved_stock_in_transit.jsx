                            ...
                            <table className="ti-custom-table border-0 whitespace-nowrap">
                                <tbody>
                                    ...
                                    {selectedRowData.product_details.map((product, index) => (
                                        <tr key={index} className="flex items-center !border-0">
                                            <td className="!p-2 font-medium !text-gray-500 dark:!text-white/70 w-[252px]">Product Model ID</td>
                                            <td className="!p-2">:</td>
                                            <td className="!p-2 !text-gray-500 dark:!text-white flex items-center">
                                                <span>{product.model_id}</span>
                                            </td>
                                            <td className="!text-gray-500 dark:!text-white !p-2 flex items-center">
                                            <i className="mr-8 ml-4">quantity</i> <span>{product.quantity}</span>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>

...
const Reactivatedtvmodels = () => {
  ...
  return (
    <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Reactivated TV Models" href="/inventory/product-management" activepage="Inventory" mainpage="Reactivated TV Models" />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Reactivated tv Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "tvDetails" && (
                <div>
                    <PageHeader currentpage="Reactivate TV Model" href="/inventory/product-management" activepage="Inventory" mainpage="Reactivate TV Model" />
                    <div className="box">
                                    ...
                                    <div className="box-body xxl:px-0">
                                        <div className="space-y-5">
                                            ...
                                            <div className="sm:flex sm:space-x-5">
                                                <h5 className="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">Screen Size :</h5>
                                                <span className="my-auto font-medium text-md">
                                                    {selectedRowData.screen_size}
                                                </span>
                                            </div>
...
export default Reactivatedtvmodels;

...
const Deactivatedphones = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Deactivated Phone Models" href="/inventory/product-management" activepage="Inventory" mainpage="Deactivated Phone Models" />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Deactivated Phone Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "phoneDetails" && (
                <div>
                    <PageHeader currentpage="Deactivated Phone Model" href="/inventory/product-management" activepage="Inventory" mainpage="Deactivated Phone Model" />
                    <div className="box">
...
export default Deactivatedphones;

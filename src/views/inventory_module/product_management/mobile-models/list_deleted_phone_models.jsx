...
const Deletedphonedmodels = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Deleted Phone Models" href="/inventory/product-management" activepage="Inventory" mainpage="Deleted Phone Models" />
            ...
            {currentDiv === "phoneDetails" && (
                <div>
                    <PageHeader currentpage="Deleted Phone Model" href="/inventory/product-management" activepage="Inventory" mainpage="Deleted Phone Model" />
                    <div className="box">
...
export default Deletedphonedmodels;

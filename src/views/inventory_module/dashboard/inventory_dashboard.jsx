		...
		<div>
			...
			<div className="grid grid-cols-12 gap-6">
				...
				<div className="col-span-12 md:col-span-6 xxl:!col-span-4">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Products Models</h5>
						</div>
						<div className="box-body">
							<div className="border-b-2 border-gray-200 dark:border-white/10">
								<nav className="-mb-0.5 flex space-x-6 rtl:space-x-reverse">
												...
												<Link to="/supplier/create-supplier" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															...
															<p className="mb-0 text-sm">Create a New Product Model</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">Add a new product model</p>
											...
											<div className="sm:flex w-full space-y-2">
												<Link to="/supplier/approve-suppliers" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															<p className="mb-0 text-sm">Approve New Product Model</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">Approve a new product model</p>
														</div>
													</div>
												</Link>
											</div>
											...
											<div className="sm:flex w-full space-y-2">
												<Link to="/supplier/active-suppliers" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															<p className="mb-0 text-sm">List Active Product Models</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">List of active product models</p>
														</div>
													</div>
												</Link>
											</div>
											...
											<div className="sm:flex w-full space-y-2">
												<Link to="/supplier/deactivated-suppliers" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															<p className="mb-0 text-sm">List Deactivated Product Models</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">List of a deactivated product models</p>
														</div>
													</div>
												</Link>
											</div>
										...
										<li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
											<div className="sm:flex w-full space-y-2">
												<div className="flex space-x-3 rtl:space-x-reverse">
													...
													<div className="">
														<p className="mb-0 text-sm">Approve Reactivated Product Models</p>
														<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">Approve a product models</p>
													</div>
												</div>
											</div>
										</li>
											...
											<div className="sm:flex w-full space-y-2">
												<Link to="/supplier/deleted-suppliers" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															<p className="mb-0 text-sm">List Deleted Product Models</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">List of deleted product models</p>
														</div>
													</div>
												</Link>
											</div>

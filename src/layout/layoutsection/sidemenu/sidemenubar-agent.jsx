...
const SidemenuAgents = ({ local_varaiable, ThemeChanger }) => {
    const [menuitems, setMenuitems] = useState(MenuItems_agents);
    useEffect(() => {
...
export default connect(mapStateToProps, { ThemeChanger })(SidemenuAgents);
...
const sampleRowData = [
    ...
    {
        id: 3,
        subcategory_name: "Feature Phones",
        status: "3",
    },
    {
        id: 3,
        subcategory_name: "Smart tvs",
        status: "3",
    },
    {
        id: 3,
        subcategory_name: "OLED tvs",
        status: "3",
    },
    {
        id: 3,
...
const ProductsubCategories = () => {
    ...
    return (
        <div>
            <PageHeader currentpage="Product SubCategories" href="/inventory/product-management" activepage="Inventory" mainpage="Product SubCategories" />
            ...
            <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                ...
                />
                <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Product sub_categories.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">

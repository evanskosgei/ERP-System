...
const DeletedtvModels = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Deleted TV Models" href="/inventory/product-management" activepage="Inventory" mainpage="Deleted TV Models" />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="deleted tv Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "tvDetails" && (
                <div>
                    <PageHeader currentpage="Deleted TV Model" href="/inventory/product-management" activepage="Inventory" mainpage="Deleted TV Model" />
                    <div className="box">
...
export default DeletedtvModels;

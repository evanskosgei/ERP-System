    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader
                        currentpage="New TV Models"
                        href="/inventory/product-management"
                        activepage="Inventory"
                        mainpage="New TV Models"
                    />
            ...
            {currentDiv === "phoneDetails" && (
                <div>
                    <PageHeader currentpage="New TV Model" href="/inventory/product-management" activepage="Inventory" mainpage="New TV Model" />
                    <div className="box">
                                            ...
                                            <div className="sm:flex sm:space-x-2">
                                                ...
                                                <h5 className="font-medium text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    {editMode ? (
                                                        <input
                                                            type="text"
                                                            defaultValue={selectedRowData.screen_size}
...
export default NewUnapprovedtv;
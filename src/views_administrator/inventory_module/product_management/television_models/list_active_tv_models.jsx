...
const Activetvmodels = () => {
    ...
    return (
        ...
        {currentDiv === "table" && (
            <div>
                <PageHeader currentpage="Active TV Models" href="/inventory/product-management" activepage="Inventory" mainpage="Active TV Models" />
                ...
                <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                    ...
                    />
                    <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Active tv Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
        ...
        {currentDiv === "phoneDetails" && (
            <div>
                <PageHeader currentpage="Active TV Model" href="/inventory/product-management" activepage="Inventory" mainpage="Active TV Model" />
                <div className="box">

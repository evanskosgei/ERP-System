...
const Deactivatedtv = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Deactivated TV Models" href="/inventory/product-management" activepage="Inventory" mainpage="Deactivated TV Models" />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Deactivated tv Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "tvDetails" && (
                <div>
                    <PageHeader currentpage="Deactivated TV Model" href="/inventory/product-management" activepage="Inventory" mainpage="Deactivated TV Model" />
                    <div className="box">

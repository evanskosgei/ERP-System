...
const Reactivatedaccessory = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Reactivated Accessory Models" href="/inventory/product-management" activepage="Inventory" mainpage="Reactivated Accessory Models" />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Reactivated Accessory Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "accessoryDetails" && (
                <div>
                    <PageHeader currentpage="Reactivated Accessory Model" href="/inventory/product-management" activepage="Inventory" mainpage="Reactivated Accessory Model" />
                    <div className="box">
...
export default Reactivatedaccessory;

...
const Activeaccessories = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Active Accessories Models" href="/inventory/product-management" activepage="Inventory" mainpage="Active Accessories Models" />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
                        ...
                        />
                        <CSVLink data={filteredData.length > 0 ? filteredData : rowData} filename="Active accessory Models.csv" separator={","} className="h-6 w-6 items-center mb-7 ml-7 mr-8 text-blue-600">
            ...
            {currentDiv === "accessoryDetails" && (
                <div>
                    <PageHeader currentpage="Active Accessory Model" href="/inventory/product-management" activepage="Inventory" mainpage="Active Accessory Model" />
                    <div className="box">

...
const Newunapprovedaccessories = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader
                        currentpage="New Accessories Models"
                        href="/inventory/product-management"
                        activepage="Inventory"
                        mainpage="New Accessories Models"
                    />
                    ...
                    <div style={{ display: "flex", alignItems: "center", margin: "2" }}>
                        ...
                        <CSVLink
                            ...
                            filename="new unapproved accessory Models.csv"
                            separator={","}
            ...
            {currentDiv === "accessoryDetails" && (
                <div>
                    <PageHeader currentpage="New Accessory Model" href="/inventory/product-management" activepage="Inventory" mainpage="New Accessory Model" />
                    <div className="box">
                                ...
                                <div className="box mb-0 border-0 shadow-none bg-transparent">
                                    <div className="box-body xxl:px-0">
                                        <div className="space-y-5">
                                            ...
                                            <div className="sm:flex sm:space-x-2">
                                                ...
                                                <h5 className="font-medium text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    {editMode ? (
                                                        <input
                                                            type="text"
                                                            defaultValue={selectedRowData.type}
                                            ...
                                            <div className="sm:flex sm:space-x-2">
                                                <h5 className="font-bold text-sm my-auto w-30 text-gray-800 dark:text-white">Colours :</h5>
                                                <h5 className="font-medium text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    {editMode ? (
                                            ...
                                            <div className="sm:flex sm:space-x-2">
                                                ...
                                                <h5 className="font-medium text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    {editMode ? (
                                                        <input type="text" defaultValue={selectedRowData.make} {...register("make")} />
                                                    ) : (
...
export default Newunapprovedaccessories;

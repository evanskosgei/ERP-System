...
const ApprovedStockCashPurchased = () => {
  ...
  const columnDefs = [
    ...
    },
    {
      ...
      field: 'supplier_payable_account_number',
      sortable: true,
      editable: false,
      filter: true,
      flex: 2,
  ...
  const filteredProductDetails =
    selectedRowData?.product_details?.filter((item) =>
      Object.values(item).some(
        (value) =>
          value && typeof value === 'string' && value.toLowerCase().includes(productDetailsSearchQuery.toLowerCase()),
      ),
    ) || []
  ...
  return (
    <div>
      {currentDiv === 'listpage' && (
        <div>
          <PageHeader
            currentpage='Stock Purchased Using Cash'
            href='/inventory/dashboard/'
            activepage='Inventory'
            mainpage='Stock Purchased Details'
          />
          <div style={{ display: 'flex', alignItems: 'center', margin: '2' }}>
            ...
            <CSVLink
              ...
              filename='new_unapproved_purchased_stock'
              separator={','}
      ...
      {currentDiv === 'details' && (
        <div>
          <PageHeader
            ...
            mainpage='Stock Purchased Details'
          />
          <button className='className="flex left-0 text-blue-700 hover:bg-gray-100 p-3 font-bold' onClick={handleBack}>
                        ...
                        <div>
                          <div className='grid lg:grid-cols-2 gap-6'>
                            ...
                            <div className='space-x-3'>
                              ...
                              <span className='text-sm text-gray-800 dark:text-white/70'>
                                {user.currency}{' '}
                                {Number(selectedRowData.total_amount).toLocaleString('en-US', {
                            ...
                            <div className='space-x-3'>
                              ...
                              <span className='text-sm text-gray-800 dark:text-white/70'>
                                {' '}
                                {selectedRowData.supplier_payable_account_number}
                              </span>
                            </div>
                            ...
                            <div className='space-x-3'>
                              ...
                              <span className='text-sm text-gray-800 dark:text-white/70'>
                                {' '}
                                {selectedRowData.bank_account_number}
                              </span>
                            </div>
                      ...
                      <div className='box-body'>
                        <div className='pb-5'>
                          <div className='md:flex justify-between space-y-2 md:space-y-0'>
                            ...
                            <div className='md:ltr:ml-auto md:rtl:mr-auto'>
                              <Link to='#' className='ti-btn text-xs m-0 ti-btn-soft-success p-2'>
                                <i className='ri ri-add-circle-line'></i>View Stock in Transit
                              </Link>
                            </div>
                          </div>
                        </div>
                        <div className='overflow-auto'>
                          <table className='ti-custom-table table-bordered ti-custom-table-head'>
                            ...
                            <tbody>
                              {selectedRowData &&
                              Array.isArray(filteredProductDetails) &&
                        ...
                        <div className='py-1 ltr:float-right rtl:float-left'>
                          <nav className='flex items-center space-x-2 rtl:space-x-reverse'>
                            <Link
                              className='text-gray-500 dark:text-white/70 hover:text-primary p-4 inline-flex items-center gap-2 font-medium rounded-md'
                              to='#'
                            >
                            ...
                            <Link
                              className='w-10 h-10 text-gray-500 dark:text-white/70 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full'
                              to='#'
                            >
                              2
                            </Link>

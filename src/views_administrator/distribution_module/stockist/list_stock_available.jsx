...
const ListStockAvailable = () => {
  ...
  return (
    <div>
            {currentDiv === "listpage" && (
                <div>
                    <PageHeader currentpage="Stock Available" href="/inventory/dashboard/" activepage="Inventory" mainpage="Stock Received Available" />
...
export default ListStockAvailable;

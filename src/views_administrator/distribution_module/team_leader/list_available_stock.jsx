...
const TeamleaderStockAvailable = () => {
    ...
    return (
        <div>
            {currentDiv === "listpage" && (
                <div>
                    <PageHeader currentpage="Team Leader Stock Available" href="/inventory/distribution-dashboard/" activepage="Distribution" mainpage="Team Leader stock available" />
            ...
            {currentDiv === "details" && (
                <div>
                    <PageHeader currentpage="Team Leader Stock Available" href="/inventory/distribution-dashboard/" activepage="Distribution" mainpage="Manager Stock Pending Dispatch" />

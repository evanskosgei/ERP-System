		...
		<div>
			...
			<div className="grid grid-cols-12 gap-6">
				<div className="col-span-12 md:col-span-6 xxl:!col-span-4">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Business Accounts</h5>
						</div>
				...
				<div className="col-span-12 md:col-span-6 xxl:!col-span-4">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Capital Injection</h5>
						</div>
						<div className="box-body">
							<div className="border-b-2 border-gray-200 dark:border-white/10">
								<nav className="-mb-0.5 flex space-x-6 rtl:space-x-reverse">
												...
												<Link to="/finance/create-capital-injection" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															...
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">Create capital injection transaction</p>
											...
											<div className="sm:flex w-full space-y-2">
												<Link to="/finance/new-unapproved-capital-injection" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															<p className="mb-0 text-sm">Approve Capital Injection Record</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">Approve capital injection transaction</p>
														</div>
													</div>
												</Link>
											</div>
											...
											<div className="sm:flex w-full space-y-2">
												<Link to="/finance/active-capital-injection" className="">
													<div className="flex space-x-3 rtl:space-x-reverse">
														...
														<div className="">
															<p className="mb-0 text-sm">List Capital Injection Transactions</p>
															<p className="mb-0 text-gray-500 dark:text-white/70 text-xs">List of capital injection transactions</p>
														</div>
													</div>
												</Link>
											</div>

...
const Deactivatedusers = () => {
    ...
    return (
        <div>
            {currentDiv === "table" && (
                <div>
                    <PageHeader currentpage="Deactivated Users" href="/users/dashboard" activepage="Users" mainpage="Deactivated Users" />
            ...
            {currentDiv === "Activesupplier" && (
                <div>
                    <PageHeader currentpage="Deactivated user Details" activepage="user" mainpage="Deactivated user Details" />
